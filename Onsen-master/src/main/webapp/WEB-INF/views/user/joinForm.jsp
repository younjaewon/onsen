        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				...
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
						href="login">로그인</a></li>
					<li class="nav-item"><a class="nav-link js-scroll-trigger"
						href="join"><font class="font_underline"><p class="d">회원가입</p></font></a></li>
				</ul>
			</div>
				...
				<form:form modelAttribute="user" Name='joinForm' Method='post'
					...
					<div>
						...
						<span class="box int_pass"> <form:password path="pass"
								id="pass" name="pass" class="int" minlength="6" maxlength="20" /> <span
					...
					<div>
						...
						<span class="box int_mobile"> <input type="text"
							name='phone' id="phone" class="int" maxlength="11"
